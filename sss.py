...
st.set_page_config(page_title='Prediction ',
                   layout='wide',
                   page_icon="🧑‍⚕️")
diabetes_model=pickle.load(open(r"C:\Users\91701\Desktop\Training modules\diabetes_model.sav",'rb'))
heart_disease_model=pickle.load(open(r"C:\Users\91701\Desktop\Training modules\heart_model.sav",'rb'))
parkinson_model=pickle.load(open(r"C:\Users\91701\Desktop\Training modules\parkinson.sav",'rb'))
